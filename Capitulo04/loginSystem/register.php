...
$user->status=0; // Aquí lo he cambiado de 1 a 0 por la bonus section 
/* Since we want the user to validate his own email address, we will make it invalid 
(status equals to 0) the first time he register an account to our system. */
