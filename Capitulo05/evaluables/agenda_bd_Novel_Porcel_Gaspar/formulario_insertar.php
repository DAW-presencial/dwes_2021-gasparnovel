...
include('./header.php');
include('./crud/insertar.php');
?>

<div class="container-fluid bg-3 text-center">
    <h3>AGENDA DE CONTACTOS</h3>
    <a href="index.php" class="btn btn-primary pull-right" style='margin-top:-30px'><span class="glyphicon glyphicon-eye-open"></span> Ver Contactos</a>
    <br>

    <div class="panel panel-primary">
        <div class="panel-heading">AGREGAR CONTACTO</div>
